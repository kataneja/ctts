...
public class T019_Staff_Profile_Cargo implements FwCargo {
	...
	public T019_Staff_Profile_Cargo(T019_Staff_Profile_PK pK, String first_nam,
			String last_nam, String position_cd, String bus_org_cd,
			String bus_ph_no, String home_ph_no, String st_num_adr,
			String st_name_adr, String apt_adr, String unit_adr,
			String direction_adr, String quadrant_adr, String suffix_adr,
			String line_2_adr, String city_adr, String state_adr,
			String zip_cd_adr, String company_cd, String password,
			String line_1_adr, String wi_uniq_user_id, Date dob_dt,
			Date begin_dt, Date end_dt, Long bus_ext_num,
			Character delete_flag, Character devp_region_ind,
			Character accp_region_ind, Character prod_region_ind,
			Character timesheet_reqd_ind) {
		super();
		PK = pK;
